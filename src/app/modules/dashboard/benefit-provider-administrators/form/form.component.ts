...
@Component({
  selector: 'app-benefit-provider-administrator-form',
  templateUrl: './form.component.html',
})
export class BenefitProviderAdministratorsFormComponent extends Many(ApplicationBaseComponent, FormBaseComponent)
  implements OnInit {
  public form: FormGroup;
  public formCollectionHelper = FormCollectionHelper;
  public benefitProviderAdministratorRoleList: any = [];
  ...
  private updateUserInformation() {
    ...
    this.administratorService.update(this.scope, this.user.id, params).subscribe(
      () => {
        ...
        this.router.navigate(['/dashboard/benefit-provider-administrators']);
      },
      (response) => {
