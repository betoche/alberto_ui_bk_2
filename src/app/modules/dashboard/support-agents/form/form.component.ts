...
@Component({
  selector: 'app-support-agent-form',
  templateUrl: './form.component.html',
})
export class SupportAgentsFormComponent extends Many(ApplicationBaseComponent, FormBaseComponent) implements OnInit {
  ...
  private updateUserInformation() {
    ...
    this.administratorService.update(this.scope, this.user.id, params).subscribe(
      () => {
        ...
        this.router.navigate(['/dashboard/support-agents']);
      },
      (response) => {
