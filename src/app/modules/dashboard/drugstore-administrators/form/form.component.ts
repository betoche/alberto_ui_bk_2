...
@Component({
  selector: 'app-drugstore-administrator-form',
  templateUrl: './form.component.html',
})
export class DrugstoreAdministratorsFormComponent extends Many(ApplicationBaseComponent, FormBaseComponent)
  implements OnInit {
  ...
  private updateUserInformation() {
    ...
    this.administratorService.update(this.scope, this.user.id, params).subscribe(
      () => {
        ...
        this.router.navigate(['/dashboard/drugstore-administrators']);
      },
      (response) => {
