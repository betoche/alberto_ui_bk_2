...
@Component({
  selector: 'app-medication-distributors',
  animations: egretAnimations,
  templateUrl: './medication-distributors.component.html',
  styleUrls: ['./medication-distributors.component.css']
})
export class MedicationDistributorsComponent extends DatatableBaseComponent implements OnInit {
  public rows: any = [];
