...
export class AdminLayoutComponent implements OnInit, AfterViewInit {
  ...
  public leftSidebarEnabled: Boolean = false;
  public scrollConfig = {};
  ...
  constructor(
    ...
    this.leftSidebarEnabled = this.leftSidebarService.leftSidebarEnabled
  }
  ngOnInit() {
    ...
    this.leftSidebarService.leftSidebarEnabledBS.subscribe(leftSidebarEnabled => {
      this.leftSidebarEnabled = leftSidebarEnabled
      this.adminContainerClasses = this.updateAdminContainerClasses(this.layoutConf)
    })
  }
  ...
  updateAdminContainerClasses(layoutConf) {
    return {
      ...
      'left-sidebar-enabled': this.leftSidebarEnabled
    };
  }
}
